INSERT INTO KORISNIK (username, password, name, surname, phonenumber, mail, birthday, role) VALUES ('Marko123','nekiPassword', 'Marko', 'Markovic', 065555555, 'user@gmail.com', '2001-01-01', 'Gledaoc');
...
INSERT INTO KORISNIK (username, password, name, surname, phonenumber, mail, birthday, role, bioskop_id) VALUES ('menadzer01','nekiPassword', 'Stefan', 'Stefanovic', 065775566, 'user@gmail.com', '1999-01-01', 'Menadzer', 1);
...
INSERT INTO TERMINSKA_LISTA_PROJEKCIJA (BRREZERVACIJA, DATE, CENA, FILM_ID, SALA_ID) VALUES(1, '2020-11-11', 200, 2, 1);
